...
const Sidebar = () => {
  return (
    <div className="bg-pink-900 text-pink-300 w-1/5 pb-6 hidden md:block">
      <div className="flex items-center mb-6 px-4 mt-3 border-b border-pink-800">
        <span className="bg-green-500 rounded-full block w-2 h-2 mr-2"> </span>
        <span className="text-pink-100 flex ">Olivia</span>
        <svg
          className="h-6 mb-6 w-6 text-pink-100 fill-current justify-between"
          viewBox="0 0 32 32"
        >
          <g id="surface1">
      ...
      <div className="px-4 mb-2 font-sans flex ">
        <span className="text-l text-pink-200 p-2 pr-5 flex">Channels</span>
        <button type="button" className="text-l text-pink-200 p-2">
          +
        </button>
      </div>
      <ChanelList />
      ...
      <div className="flex items-center mb-3 px-4">
        <span className="bg-green-500 rounded-full block w-2 h-2 mr-2"> </span>
        <span className="text-pink-100">Adam Bishop</span>
      </div>

      <div className="flex items-center px-4 mb-6">
        <span className="border rounded-full block w-2 h-2 mr-2"> </span>
        <span className="text-pink-100">killgt</span>
      </div>
